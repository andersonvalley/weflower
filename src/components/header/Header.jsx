...
function Header() {
  const { totalPrice, totalQuantity } = useSelector(state => state.cartItems)
  ...
  return (
    <div className={styles.header}>
      <div className={styles.container}>
        <Link onClick={() => dispatch(searchItems(''))} to='/' className={styles.logo}>
          <img width='70' src={Logo} alt='WEFlower' />
          <div>
            <h1>WEFlower</h1>
            <p>доставка цветов в Санкт-Петербурге</p>
          </div>
        </Link>
