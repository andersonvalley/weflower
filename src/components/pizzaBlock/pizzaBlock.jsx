...
function PizzaBlock({ addItemToCart, obj }) {
  ...
  return (
    <div className='pizza-block'>
      <img className='pizza-block__image' src={obj.imageUrl} alt={obj.title} />
      ...
      <div
        onClick={() => addItemToCart(obj, activeSize, typeNames[activeType], countPrice(obj.price))}
        className='pizza-block__bottom'
      >
        <div className='pizza-block__price'>от {countPrice(obj.price)} ₽</div>
        <div
          className={
